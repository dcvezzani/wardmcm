...
RSpec.describe TextMessagesController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested text_message as @text_message" do
      text_message = TextMessage.create! valid_attributes
      get :show, params: {id: text_message.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested text_message as @text_message" do
      text_message = TextMessage.create! valid_attributes
      get :edit, params: {id: text_message.to_param}, session: valid_session
      expect(assigns(:text_message)).to eq(text_message)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new TextMessage" do
        expect {
          post :create, params: {text_message: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved text_message as @text_message" do
        post :create, params: {text_message: invalid_attributes}, session: valid_session
        expect(assigns(:text_message)).to be_a_new(TextMessage)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested text_message" do
        text_message = TextMessage.create! valid_attributes
        put :update, params: {id: text_message.to_param, text_message: new_attributes}, session: valid_session
        text_message.reload
      ...
      it "assigns the requested text_message as @text_message" do
        text_message = TextMessage.create! valid_attributes
        put :update, params: {id: text_message.to_param, text_message: valid_attributes}, session: valid_session
        expect(assigns(:text_message)).to eq(text_message)
      end
    ...
    context "with invalid params" do
      it "assigns the text_message as @text_message" do
        text_message = TextMessage.create! valid_attributes
        put :update, params: {id: text_message.to_param, text_message: invalid_attributes}, session: valid_session
        expect(assigns(:text_message)).to eq(text_message)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested text_message" do
      text_message = TextMessage.create! valid_attributes
      expect {
        delete :destroy, params: {id: text_message.to_param}, session: valid_session
      }.to change(TextMessage, :count).by(-1)
    end
