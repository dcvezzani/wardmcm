class DateTimeInput < SimpleForm::Inputs::DateTimeInput
  def input(wrapper_options)
    #template.content_tag(:input, nil, {id: "#{self.lookup_model_names}_#{self.attribute_name}_date", class: 'form-control datetime optional', name: "#{self.lookup_model_names}[#{self.attribute_name}]"})
